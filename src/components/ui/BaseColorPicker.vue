...
<template>
  <div class="inline-flex flex-col items-end gap-1.5">
    <label
      class="hover-accent-border relative inline-flex h-8 w-14 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-lg border border-zinc-200 bg-white hover:ring-2 hover:ring-violet-500/10 focus-within:border-violet-500 focus-within:ring-2 focus-within:ring-violet-500/10 dark:border-zinc-700 dark:bg-zinc-800"
